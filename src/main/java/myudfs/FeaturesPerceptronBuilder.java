...
public class FeaturesPerceptronBuilder extends StoreFunc {
    ...
    public OutputFormat getOutputFormat() {
        return new FeaturesPerceptronClassifierOutputFormat();
    }
    ...
    public class FeaturesPerceptronClassifierOutputFormat extends FileOutputFormat<Integer, Map<String, Float>> {
        private SequenceFileOutputFormat<NullWritable, Perceptron> outputFormat = null;

        public FeaturesPerceptronClassifierOutputFormat() {
        ...
        public RecordWriter<Integer, Map<String, Float>> getRecordWriter(
            ...
            return new FeaturesPerceptronClassifierRecordWriter(outputFormat.getRecordWriter(context), builderFeatureBit, builderConvertType, modelPath);
        }

    }

    public class FeaturesPerceptronClassifierRecordWriter extends RecordWriter<Integer, Map<String, Float>> {

        private RecordWriter writer = null;
        private Perceptron classifier = null;

        public FeaturesPerceptronClassifierRecordWriter(RecordWriter<NullWritable, Perceptron> writer, int featureBit, BinaryOnlineClassifier.FeatureConvert convertType, String modelPath) {
            this.writer     = writer;
