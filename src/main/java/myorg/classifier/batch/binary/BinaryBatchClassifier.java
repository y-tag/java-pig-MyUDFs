...
public class BinaryBatchClassifier implements Writable {
    ...
    public BinaryBatchClassifier() {
    }
    
    public BinaryBatchClassifier(int featureBit) {
        this(featureBit, Convert.FeatureConvert.PARSING);
    }

    public BinaryBatchClassifier(int featureBit, Convert.FeatureConvert convertType) {
    ...
    public BinaryBatchClassifier(List<BinaryBatchClassifier> classifierList) {
